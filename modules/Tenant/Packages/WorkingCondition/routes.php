...
use Modules\Tenant\Packages\WorkingCondition\Controllers\WorkingConditionController;
...
Route::group(['middleware' => [
    ...
    Route::controller(WorkingConditionController::class)
        ->prefix('working_condition')
        ->group(function () {
