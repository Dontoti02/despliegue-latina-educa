...
use Modules\Tenant\Packages\AcademicHistory\Controllers\AcademicHistoryController;
...
Route::group(['middleware' => [
    ...
    Route::controller(AcademicHistoryController::class)
        ->prefix('academic_history')
        ->group(function () {
            Route::get('filters/{studentId}', 'filters');
